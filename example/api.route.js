 ...
 * @apiBody {String{6..20}} username Username for login
 * @apiBody {String} [password] If not provided will be auto generated
 * @apiBody {String="User", "Admin", "Moderator"} [userGroup="User"] User group the user belongs to
 * 
 ...
 * @apiBody {String} [name] User full name
 * @apiBody {String="User", "Admin", "Moderator"} [userGroup] User group the user belongs to
 * 
 * @apiExample {curl} curl
